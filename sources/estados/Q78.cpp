...
void Q78::Caso(map<string, Instrucao>& tab_inst, map<string, Diretiva>& tab_diret, map<string, Simbolo>& tab_simbol,
      ...
      cout << "ESTADO Q78: " << endl;

    lexema += c;
    cout << "ESTADO Q78: "<< lexema << endl;
    if (c == 'R'){
        estado = 79;
