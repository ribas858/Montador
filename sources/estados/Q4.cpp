...
void Q4::Caso(map<string, Instrucao>& tab_inst, map<string, Diretiva>& tab_diret, map<string, Simbolo>& tab_simbol,
        ...
        cout << "ESTADO Q4: " << "C == " << c << " -- " << "lexema: " << lexema << " -- ";
    if (c != ' ' && c != '\n' && c != ';' && c != ':' && c != ',') lexema += c;
    ...
    cout << "ESTADO 4: " << lexema << " f_l[0]: " << forma_linha[0] << " f_l[1]: " << forma_linha[1] << endl;
    //cout << "É uma letra " << c << endl;
}                       