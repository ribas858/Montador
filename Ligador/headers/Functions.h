...
class Functions {
    ...
    public:
        ...
        static void tabs_ligador(map<string, Definicao>& tab_def, map<string, Uso>& tab_uso, string& linha, int& flag_uso, int& flag_def, int flag_cod, vector<int>& cod_obj);
        ...
        static void remove_w(string& a, string key);
